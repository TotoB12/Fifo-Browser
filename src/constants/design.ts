...
export const DEFAULT_TAB_MARGIN_BOTTOM = 4;
export const COMPACT_TAB_MARGIN_TOP = 3;
export const COMPACT_TAB_MARGIN_BOTTOM = 3;
...
export const DEFAULT_TITLEBAR_HEIGHT =
  DEFAULT_TAB_MARGIN_TOP + DEFAULT_TAB_HEIGHT + DEFAULT_TAB_MARGIN_BOTTOM;
export const COMPACT_TITLEBAR_HEIGHT =
  2 * COMPACT_TAB_MARGIN_TOP + COMPACT_TAB_HEIGHT+ COMPACT_TAB_MARGIN_BOTTOM;
